 ...
 * @version 127.2.0 (Messaging Fix)
 * @comment Separated the 'Message Client' form handler from the other form handlers to prevent conflicts and ensure messages are sent reliably.
 */
...
jQuery(function($) {
    ...
    // ** NEW: Dedicated handler for the message client form **
