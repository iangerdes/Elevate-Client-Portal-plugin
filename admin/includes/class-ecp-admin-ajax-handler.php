 ...
 * @version 127.6.0 (Message Client Fix)
 * @comment Corrected the method call to use the renamed 'send_client_message' function, fixing the fatal error.
 */
    ...
    public function ajax_dashboard_handler() {
        ...
        switch($sub_action) {
            ...
            case 'save_role_permissions':
                ...
                break;
            // ** FIX: Changed message_client_logic to send_client_message to match the actual function name. **
            case 'message_client':
                $result = ECP_User_Manager::send_client_message($_POST);
                break;
        }
