 ...
 * @version 79.0.0 (Delete ZIP Fix)
 * @comment Added the missing 'delete_zip' nonce to the script localization, fixing the AJAX error when deleting a ready download.
 */
class ECP_Client_Portal_Assets {
    ...
    public function enqueue_scripts() {
        ...
        wp_localize_script( 'ecp-client-portal', 'ecp_ajax', [
            ...
            'home_url' => home_url('/'),
            // ** FIX: Added 'delete_zip' to the nonces array. **
            'nonces'   => ECP_Security_Helper::get_script_nonces(['client_portal', 'decrypt_file', 'contact_manager', 'update_account', 'zip', 'delete_zip']),
            'strings'  => [
