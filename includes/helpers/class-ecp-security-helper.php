 ...
 * @version 126.0.0 (AJAX Password Reset)
 * @comment Added a 'lost_password' nonce for the new AJAX password reset functionality.
 */
...
class ECP_Security_Helper {
    ...
    private static $nonces = [
        ...
        'zip_download'    => 'ecp_zip_download_nonce',
        'logout'          => 'ecp_logout_nonce',
        'ajax_login'      => 'ecp_ajax_login_nonce',
        'lost_password'   => 'ecp_lost_password_nonce',
    ];
