<?php
// File: elevate-client-portal/frontend/views/admin-dashboard-user-form.php
/**
 * Renders the Add/Edit User form for the Admin Dashboard.
 * This view is included by class-ecp-admin-dashboard.php
 *
 * @package Elevate_Client_Portal
 * @version 13.4.0 (Permission Fix)
 * @comment Decoupled the 'Managed By' field from the 'promote_users' capability check, allowing users with 'edit_users' (like Client Managers) to see and set it.
 */
...
<div class="ecp-dashboard-view ecp-form-view" id="ecp-user-form-view">
    <?php
    $title = $is_new_user ? __('Add New User', 'ecp') : __('Edit User:', 'ecp') . ' ' . esc_html($user->display_name);
    $is_main_view = false;
        ...
        <table class="form-table"><tbody>
            ...
            <tr>
                ...
                <?php if (!$is_new_user && !current_user_can('promote_users')): ?>
                    <p class="description"><?php _e('Only users with permission to promote can change another user\'s email address.', 'ecp'); ?></p>
                <?php endif; ?>
                </td>
            </tr>
