 ...
 * @version 98.0.0 (Direct Asset Loading)
 * @comment Re-engineered to load assets directly from the shortcode for improved reliability, fixing issues where scripts would fail to load.
 */
class ECP_Client_Portal {
    ...
    public function render_shortcode() {
        ...
        // ** FIX: Directly enqueue the scripts for this shortcode. **
